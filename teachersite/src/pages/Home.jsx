              ...
              <div className="mt-4 text-sm text-gray-700">
                <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x sm:divide-blue-100">
                  ...
                  <div className="py-3 px-4">
                    ...
                    <div className="text-xs text-gray-500 mt-3">Khoa / Đơn vị:</div>
              ...
              <div className="lg:col-span-2 space-y-6">
                <div className="bg-white rounded-lg shadow p-6">
                  <div className="flex justify-between items-center">
                    <div>
                      <h1 className="text-2xl font-semibold">Xin chào, {teacher.name} {teacher.teacher_identifier ? `(${teacher.teacher_identifier})` : ''}</h1>
                      <p className="text-sm text-gray-500">{teacher.academic_title ? `${teacher.academic_title} · ` : ''}{teacher.faculty?.name || ''}</p>
                    </div>
                  </div>
