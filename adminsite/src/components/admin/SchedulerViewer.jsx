...
import {generateAllSchedules, saveSchedule} from "../../services/scheduleService.js";
...
const ScheduleViewer = ({courses, teachers, rooms, resultData}) => {
    ...
    const handleSave = () => {
        ...
        saveSchedule(a).then((r) => {
            ...
            generateAllSchedules(r.generation_id).then(() => {
                console.log('Tạo tất cả schedule instances thành công');
            });
