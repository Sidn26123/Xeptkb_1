      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
        ...
        <div className="relative flex-1">
          <input
            type="text"
            value={query}
            onChange={(e) => { setQuery(e.target.value); setShowSuggestions(true); setSelectedClassId(''); }}
          ...
          {showSuggestions && query && Array.isArray(_classes) && _classes.filter(c => {
            ...
            <ul className="absolute z-50 left-0 right-0 bg-white dark:bg-gray-800 border rounded mt-1 max-h-56 overflow-auto shadow">
                ...
                <li key={c.id} className="px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer" onMouseDown={() => { handleSelectClass(c); }}>
