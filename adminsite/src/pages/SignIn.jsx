...
export default function SignIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Expect server to return accessToken, refreshToken and role
      if (data && data.accessToken) {
        const role = data.role || data?.user?.role || null;
        // only allow admin role to sign in to adminsite
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/reset-password" className="text-sm text-blue-600">Forgot password?</Link>
            </div>
