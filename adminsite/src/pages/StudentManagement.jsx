...
import {bulkImportClasses, getAllClasses} from "../services/classService.js";
import {
    getAllStudents,
    createStudent,
    updateStudent,
    deleteStudent, bulkImportStudents,
...
export default function StudentManagement() {
    ...
    const studentImportMapping = {
        'Mã sinh viên': 'student_identifier',
        'Họ và tên': 'name',
        'Mã lớp': 'class_code', // Excel nhập Mã lớp -> Backend map sang ID
    ...
    return (
        <>
                    ...
                    <form onSubmit={formInstance.handleSubmit(handleSubmit)} className="space-y-5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                />
                                <p className="text-xs text-gray-500 mt-1">Được tạo tự động từ Mã sinh viên; không thể
                                    chỉnh sửa.</p>
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" {...formInstance.register('date_of_birth')}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block mb-2 text-sm font-semibold text-gray-700">Số chứng minh /
                                    CCCD</label>
                                <input {...formInstance.register('id_number')}
                            ...
                            <div>
                                ...
                                <input {...formInstance.register('ethnicity')}
                                       className="w-full border border-green-300 rounded-lg px-4 py-2"
                                       placeholder="Dân tộc"/>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input {...formInstance.register('nationality')}
                                   className="w-full border border-green-300 rounded-lg px-4 py-2"
                        ...
                        <div>
                            ...
                            <textarea {...formInstance.register('address')}
                                      className="w-full border border-green-300 rounded-lg px-4 py-2"
                                      placeholder="Địa chỉ liên hệ" rows={3}/>
                        </div>
            ...
            <DataImportModal
                ...
                templateName={"classes_import_template.xlsx"}
                columnMapping={studentImportMapping} // Map cột Excel
