...
export default function ClassManagement() {
    ...
    const handleCategoryChange = (id) => {
        ...
        setSelectedCategory(prev => (String(prev) === String(id) ? 'all' : id));
    };
    ...
    return (
        <>
                ...
                <div className="flex justify-between items-center p-4">
                    <div className="flex items-center gap-3">
                        <input
                            ...
                            placeholder="Tìm theo tên lớp hoặc khoa"
                                ...
                                <td className="px-4 py-3 text-center">
                                    ...
                                    <Button size="sm" variant="danger" onClick={() => {
                                        if (window.confirm('Bạn có chắc muốn xóa lớp này?')) {
                                            deleteClass(cls.id).then(() => fetchList()).catch(e => console.error(e));
                                        }
                                    }}>Xóa</Button>
                                </td>
                            </tr>
            ...
            <Modal isOpen={isAddOpen} onClose={handleAddClose}
                ...
                <div className="p-8 bg-gradient-to-br from-white via-gray-50 to-gray-100 rounded-xl shadow-lg">
                    ...
                    <form className="space-y-5" onSubmit={async (e) => {
                        ...
                        {errors && <div
                            className="text-sm text-red-500">{typeof errors === 'string' ? errors : JSON.stringify(errors)}</div>}
                        ...
                        <div className="flex justify-end mt-6 gap-3">
                            <Button size="md" variant="primary"
                                    className="bg-blue-600 hover:bg-blue-700 font-semibold px-6 py-2 rounded-lg shadow"
            ...
            {/* TrainingType modal */}
            <Modal isOpen={isTTModalOpen} onClose={() => setIsTTModalOpen(false)}
                   className="max-w-md w-full mx-auto bg-white/98 shadow-2xl">
                <div className="p-6">
                    ...
                    <form onSubmit={handleSaveTT} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input className="w-full border rounded px-3 py-2" value={ttForm.code}
                                   onChange={(e) => setTtForm({...ttForm, code: e.target.value})} required/>
                        </div>
                        <div>
                            <label className="block mb-1 text-sm">Mô tả</label>
                            <textarea className="w-full border rounded px-3 py-2" value={ttForm.description}
